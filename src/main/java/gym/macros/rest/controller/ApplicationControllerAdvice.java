...
import gym.macros.rest.exception.ApiErrors;
...
public class ApplicationControllerAdvice {
    ...
    public ApiErrors handleRegraNegocioException(BussinesRuleException ex){
    ...
    public ApiErrors handlePedidoNotFoundException( DietNotFoundException ex ){
